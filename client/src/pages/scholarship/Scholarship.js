    ...
    <div className="scholarship">
      <div className="heading-scholarship">
        <div className="top-heading">
          <div className="overlay-donate"><p>Donate</p></div>
        ...
        <div className="checkout">      
          ...
          >
            <div className="donate-btn">
              <p className="checkout-btn-text">{isLoading ? "Loading..." : "Donate Now"}</p>
            </div>
      ...
      <div className="scholarship-banner"><img src={DonateBanner} alt="DonateBanner" draggable="false"/></div>
    </div>
      ...
      <div className="scholarship-form">
        ...
        <div className="contactFormContainer">
          <form action="https://formspree.io/f/xgebelva" method="POST">
            <div className="name">
              <label for="text"> <input type="text" name="Name" id="name" placeholder="First Name*" required/></label>
              <label for="text"> <input type="text" name="Name" id="name" placeholder="Last Name*" required/></label>
            </div>
            <label for="email"> <input type="email" name="_replyto" id="email" placeholder="Your Email*" required/> </label>
            <label for="text"> <input type="text" name="_replyto" id="board" placeholder="Your 10th Board Marks*" required/> </label>
            <label for="text"> <input type="text" name="_replyto" id="board" placeholder="Your 12th Board Marks*" required/> </label>
            <label> <textarea name="message" rows={6} placeholder="Why you need this Scholarship? Write in brief*"></textarea>
            </label>
