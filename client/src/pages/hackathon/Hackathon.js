    ...
    async function call() {
      try {
        let resp = await Axios.get(
          `${process.env.REACT_APP_SERVER_URL}/hackathons`
        );
      ...
      <div className="hackathon-banner-section">
        <div className="left">
          <div className="left-image">
            <img
              src={HackathonBanner2}
              alt={HackathonBanner2}
              className="hackathon-banner-image"
            />
          </div>
          ...
          <div className="opportunity-card">
            ...
            <div className="opportunity-list">
              ...
              <div className="opportunity-list1">
                ...
                <div className="right">
                  <p>
                    Women Code to Win 2023 - India | PPIs & ₹4,50,000 in prizes!
                  </p>
                </div>
              </div>
              <div className="opportunity-list1">
