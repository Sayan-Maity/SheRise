        ...
        <div className="livechat-inner">
          <div className="mentor-group">
            <div className="mentor-groupchat-div">
              <div className="mentor-groupchat-heading">
                <p>Groupchat with Mentor :</p>
              </div>
                ...
                <div className="mentor-groupchat-card">
                  <div className="top">
                    ...
                    <div className="mentor-groupchat-desc">
                      ...
                      <div className="date">
                        <p>Created 14/12/2021</p>{" "}
                      </div>
                      <div className="admin">
                        {" "}
                        <p>Admin: </p> <p>Anthony</p>{" "}
                      </div>
                    </div>
                  </div>
                  ...
                  <div className="bottom">
                    ...
                    <div className="group-members-images">
                      <div className="images">
                        ...
                        <div className="image4 grp-image">
                          <p>+5</p>
                        </div>
                      </div>
                ...
                <div className="mentor-groupchat-card">
                  <div className="top">
                    ...
                    <div className="mentor-groupchat-desc">
                      ...
                      <div className="date">
                        <p>Created 14/12/2019</p>{" "}
                      </div>
                      <div className="admin">
                        {" "}
                        <p>Admin: </p> <p>Joshua</p>{" "}
                      </div>
                    </div>
                  </div>
                  <div className="groupchat-divider"></div>
            ...
            <div className="individual-mentor-div">
              <div className="individual-mentor-heading">
                <p>Connect Individual Mentors :</p>
              </div>
              <div className="searchbar-individual-mentors">
                <input type="text" placeholder="Search Mentors ..." />
                <div className="search-mentor-btn">
                  <p>Search</p>
                </div>
              </div>
                  ...
                  <div className="top">
                    ...
                    <div className="individual-mentor-desc">
                      ...
                      <div className="company">
                        <HiOutlineBuildingOffice2 /> <p>Google</p>{" "}
                      </div>
                      <div className="profession">
                        <BsPerson /> <p>Hiring Manager</p>{" "}
                      </div>
                    </div>
                  </div>
                  <div className="bottom">
                ...
                <div className="individual-mentor-card">
                  <div className="top">
                    ...
                    <div className="individual-mentor-desc">
                      ...
                      <div className="company">
                        <HiOutlineBuildingOffice2 /> <p>Appwrite</p>{" "}
                      </div>
                      <div className="profession">
                        <BsPerson /> <p>Recruiter</p>{" "}
                      </div>
                    </div>
                  </div>
                  <div className="bottom">
                ...
                <div className="individual-mentor-card">
                  <div className="top">
                    ...
                    <div className="individual-mentor-desc">
                      ...
                      <div className="company">
                        <HiOutlineBuildingOffice2 /> <p>Microsoft</p>{" "}
                      </div>
                      <div className="profession">
                        <BsPerson /> <p>Recruiter</p>{" "}
                      </div>
                ...
                <div className="individual-mentor-card">
                  <div className="top">
                    ...
                    <div className="individual-mentor-desc">
                      ...
                      <div className="company">
                        <HiOutlineBuildingOffice2 /> <p>Sharechat</p>{" "}
                      </div>
                      <div className="profession">
                        <BsPerson /> <p>Hiring Manager</p>{" "}
                      </div>
                ...
                <div className="individual-mentor-card">
                  <div className="top">
                    ...
                    <div className="individual-mentor-desc">
                      ...
                      <div className="company">
                        <HiOutlineBuildingOffice2 /> <p>Amazon</p>{" "}
                      </div>
                      <div className="profession">
                        <BsPerson /> <p>Hiring Manager</p>{" "}
                      </div>
                ...
                <div className="individual-mentor-card">
                  <div className="top">
                    ...
                    <div className="individual-mentor-desc">
                      ...
                      <div className="company">
                        <HiOutlineBuildingOffice2 /> <p>Attlasian</p>{" "}
                      </div>
                      <div className="profession">
                        <BsPerson /> <p>Recruiter</p>{" "}
                      </div>
                ...
                <div className="individual-mentor-card">
                  <div className="top">
                    ...
                    <div className="individual-mentor-desc">
                      ...
                      <div className="company">
                        <HiOutlineBuildingOffice2 /> <p>Github</p>{" "}
                      </div>
                      <div className="profession">
                        <BsPerson /> <p>Recruiter</p>{" "}
                      </div>
                ...
                <div className="individual-mentor-card">
                  <div className="top">
                    ...
                    <div className="individual-mentor-desc">
                      ...
                      <div className="company">
                        <HiOutlineBuildingOffice2 /> <p>Airbnb</p>{" "}
                      </div>
                      <div className="profession">
                        <BsPerson /> <p>Recruiter</p>{" "}
                      </div>
          ...
          <div className="live-people-div">
            <div className="live-people-card">
              <div className="live-people">
                ...
                <div className="live-people-chat-icon">
